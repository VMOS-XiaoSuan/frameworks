...
public:
    ...
    status_t            writeInterfaceToken(uint32_t sdkint, const String16& interface);
    ...
    bool                enforceInterface(uint32_t sdkint, const String16& interface,
                                         IPCThreadState* threadState = NULL) const;

    bool                checkInterface(IBinder*) const;

    bool                checkInterface(uint32_t sdkint, IBinder*) const;
