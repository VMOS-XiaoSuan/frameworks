...
class GraphicBuffer
    : public WindowsBufferANativeObjectBase< ANativeWindowBuffer, GraphicBuffer, RefBase >,
...
#if 0
    static sp<GraphicBuffer> from(ANativeWindowBuffer* anwb) {
...
#endif
//extern void hostlibuiGraphicBuffer(void);
